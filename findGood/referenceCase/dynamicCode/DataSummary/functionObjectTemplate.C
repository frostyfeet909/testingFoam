...
void DataSummaryFunctionObject::read(const dictionary& dict)
{
    if (false)
    {
        Info<<"read DataSummary sha1: c404155b6d7d56732a6680a4e92853d4fbfa38c2\n";
    }
...
void DataSummaryFunctionObject::execute()
{
    if (false)
    {
        Info<<"execute DataSummary sha1: c404155b6d7d56732a6680a4e92853d4fbfa38c2\n";
    }
...
void DataSummaryFunctionObject::end()
{
    if (false)
    {
        Info<<"end DataSummary sha1: c404155b6d7d56732a6680a4e92853d4fbfa38c2\n";
    }
...
void DataSummaryFunctionObject::timeSet()
{
    if (false)
    {
        Info<<"timeSet DataSummary sha1: c404155b6d7d56732a6680a4e92853d4fbfa38c2\n";
    }
...
void DataSummaryFunctionObject::write()
{
    if (false)
    {
        Info<<"write DataSummary sha1: c404155b6d7d56732a6680a4e92853d4fbfa38c2\n";
    }
